...
export default function Domain2Graph({ onOutcome, onAnswersChange, initialAnswers }: DomainGraphProps = {}) {
  ...
  const CASCADE: (keyof Answers)[] = ['q21', 'q22', 'q23', 'q24', 'q25'];
  const QLABELS: Record<keyof Answers, string> = { q21: '2.1', q22: '2.2', q23: '2.3', q24: '2.4', q25: '2.5' };
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', fontFamily: 'system-ui,sans-serif', background: '#f0fdfa', overflow: 'hidden' }}>
